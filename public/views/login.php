          ...
          <div class="row no-gutters">
            <div class="col-lg-6 section-img">
              ...
              <h4 class="header">Welcome to DocWebox</h4>
               ...
               <a href="../../../DocWebox/index.php" id="back-home" class="d-flex justify-content-center align-self-end">Back to home page</a>
            ...
            <div class="col-lg-6 section-form">
              <form class="">
                ...
                <div class="form-row d-flex justify-content-center align-items-center">
                  <div class="col-lg-7">
                      <button type="button" class="btns my-2 p-2 first-btn mt-4" >Login as a Doctor</button>
                  </div>
                </div>
                ...
                <div class="form-row d-flex justify-content-center align-items-center">
                  <div class="col-lg-7">
                      <button type="button" class="btns my-2 p-1 second-btn">Register as a Doctor</button>
                  </div>
