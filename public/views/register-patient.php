...
<html>
    <head>
      ...
      <title>Register Page Patient</title>
    </head>
    <body>
    <section class="my-5 mx-5">
        <div class="container">
          ...
          <div class="col-lg-6 section-form">
              <form class="">
                <h4 class="font-weigth-bold header">Welcome. Register as a Patient and become a member</h4>
                ...
                <div class="form-row d-flex justify-content-center align-items-center">
                  <div class="col-lg-7">
                      <button type="button" class="btns my-2 p-2 first-btn mt-4" id="patient-first-btn" >Register as a Patient</button>
                  </div>
                </div>
